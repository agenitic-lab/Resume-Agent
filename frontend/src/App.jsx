  ...
  return (
    <div className="min-h-screen bg-gray-100 text-neutral-900">
      ...
      <Routes>
        ...
        <Route path="/templates" element={<ProtectedRoute><DashboardLayout><div className="p-12"><h1 className="text-4xl font-black text-neutral-900 mb-2 italic tracking-tighter uppercase">Templates</h1><p className="text-neutral-400 text-[10px] font-black uppercase tracking-widest">Library of optimized resume frameworks - Coming Soon</p></div></DashboardLayout></ProtectedRoute>} />
