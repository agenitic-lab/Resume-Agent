            ...
            {(hasApiKey === null || hasTemplate === null) ? (
                ...
                <div className="max-w-2xl mx-auto mt-12 md:mt-20">
                    ...
                    <div className="space-y-4 mb-10">
                        ...
                        {/* Template card */}
                        <div className={`bg-surface border rounded-2xl p-6 transition-all ${hasTemplate ? 'border-green-200' : 'border-red-200 shadow-sm'}`}>
                            <div className="flex items-start gap-4">
                                <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${hasTemplate ? 'bg-green-100' : 'bg-red-100'}`}>
                                    {hasTemplate ? (
                                        <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                                        </svg>
